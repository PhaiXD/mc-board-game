# ============================================================
# Board Game - Process Card on Estate (Turn-Based)
# ============================================================
...
# --- Common actions ---
execute if score @s sp_temp matches 1 run scoreboard players add @s sp_played_estate 1
...
execute if score @s sp_temp matches 1 run tellraw @a ["",{"text":"[BG] ","color":"dark_purple"},{"selector":"@s","color":"gold"},{"text":" played a card on ","color":"gray"},{"text":"Estate","color":"aqua","bold":true}]
